...
$string['apikey'] = 'SberGigaChat API Key';
$string['apikey_desc'] = 'The API key of your SberGigaChat account';
...
$string['gigachat:manage'] = 'Manage GigaChat';
$string['gigachat:view'] = 'View GigaChat';
$string['gigachatname'] = 'Assistant Name';
$string['gigachatname_desc'] = 'Define the name of your assistant';
...
$string['h5p-create'] = 'Create H5P with GigaChat';
$string['h5p-create-new'] = 'Create new H5P with GigaChat';
...
$string['h5p-manager'] = 'Manage H5P with GigaChat';
$string['h5p-manager-scorm'] = 'Manage SCORM with GigaChat';
$string['h5p-next-step'] = 'Next step';
$string['h5p-no-apikey'] = '<p>Configuring the GigaChat API key is necessary for the account creation system to work properly. This will allow the system to communicate with GigaChat to perform the required operations during the account creation process.<p><p><a href="{$a}">Click here to configure the GigaChat API key.</a></p>';
$string['h5p-page-title'] = 'Create an H5P with GigaChat';
...
$string['h5p-title'] = 'Manage GigaChat Content Bank';
...
I am {$a->gigachatname}, and I am here to make your learning journey as amazing as possible.
How can I assist you today? 🌟📚';
$string['mode'] = 'Usage Mode';
$string['mode_desc'] = 'Define which usage mode for the balloon you desire';
$string['mode_name_gigachat'] = 'GigaChat Tutor';
$string['mode_name_none'] = 'No chat balloon';
$string['model'] = 'The API Model';
$string['model_desc'] = 'The API model to be executed in SberGigaChat. Available values are on the <a href="https://developers.sber.ru/docs/ru/gigachat/models" target="_blank">SberGigaChat website</a><br>
* <strong>gigachat:latest</strong>: Latest version of GigaChat model, with improved capabilities and performance.<br>
* <strong>gigachat-pro</strong>: Professional version of GigaChat, suitable for complex tasks and high-quality responses.<br>
* <strong>gigachat-max</strong>: Maximum capability version of GigaChat, for the most advanced and comprehensive responses.<br>
* <strong>gigachat-plus</strong>: Enhanced version of GigaChat with additional features and improved accuracy.';
...
$string['privacy:metadata'] = 'The GigaChat plugin stores conversation history and transmits only the full name, course name, and URL to SberGigaChat, without sharing any other personal data.';
$string['report_completion_tokens'] = 'Number of Tokens received';
$string['report_datecreated'] = 'Day';
$string['report_filename'] = 'GigaChat Assistance Usage Report';
$string['report_info'] = '<p>In the presented report, only the first 100 lines are available. To access all records, please download the complete document.</p><p>Regarding tokens, a general rule of thumb is that one token roughly corresponds to about 4 characters of common English text. This equals approximately ¾ of a word (so, 100 tokens ~= 75 words). Learn more on the <a href="https://developers.sber.ru/docs/ru/gigachat/models" target="_blank">Language Model Tokenization</a> page.</p>';
$string['report_model'] = 'GigaChat Model';
$string['report_prompt_tokens'] = 'Number of Tokens Sent';
$string['report_title'] = 'Report';
$string['send_message'] = 'Send Message';
$string['settings'] = 'Configure GigaChat';
...
$string['talk_gigachat'] = 'Talk to {$a} here';
