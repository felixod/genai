...
A [GigaChat API key](https://developers.sber.ru) is required to be able to use this plugin. The key can be set in the settings page of the plugin.
...
The plugin can be also installed by putting the contents of this directory to
    ...
    {your/moodle/dirroot}/question/bank/gigaqbank
...
2025 Gorbatov Sergey <s.gorbatov@tu-ugmk.com>
